...
- (void)test_callback_sgr {
    ...
    ansi_sgr_t expected[] = {
        {ANSI_SGR_FLAGS_OFF_MASK, ANSI_COLOR_RESET, ANSI_COLOR_RESET},
        {ANSI_SGR_FLAG_BOLD, ANSI_COLOR_UNSET, ANSI_COLOR_UNSET},
        {ANSI_SGR_FLAG_ITALIC, ANSI_COLOR_UNSET, ANSI_COLOR_UNSET},
        {ANSI_SGR_FLAG_UNDERLINE, ANSI_COLOR_UNSET, ANSI_COLOR_UNSET},
        {ANSI_SGR_FLAG_NONE, ansi_color_pack_indexed(7), ANSI_COLOR_UNSET},
        {ANSI_SGR_FLAG_NONE, ANSI_COLOR_UNSET, ansi_color_pack_rgb(0, 10, 20)},
        {ANSI_SGR_FLAG_NONE, ANSI_COLOR_RESET, ANSI_COLOR_UNSET},
        {ANSI_SGR_FLAG_NONE, ANSI_COLOR_UNSET, ANSI_COLOR_RESET},
    };
