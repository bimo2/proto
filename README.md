...
**A GPU native terminal designed for Apple ARM64 machines.** o1 is implemented in C and Metal using Apple SoC's unified memory architecture for high performance, maximum throughput and low latency. See `man o1` for user defaults including:
...
You can download precompiled static libraries and DMG binaries from the [GitHub Releases](https://github.com/bimo2/proto/releases) section.
